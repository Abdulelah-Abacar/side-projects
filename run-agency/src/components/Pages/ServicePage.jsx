...
const serviceData = [
  {
    ...
    thumbnailSrc:
      "https://cronuts.digital/wp-content/uploads/2022/02/20943477-scaled.jpg", // Growth chart/analytics
  ...
  },
  {
    ...
    subTitle:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem aperiam, eaque ipsa quae.",
    thumbnailSrc:
      "https://images.unsplash.com/photo-1626785774573-4b799315345d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&h=200&q=80", // Design tools and branding elements
    href: "/service/service-details",
  },
  {
    number: "03",
    ...
    subTitle:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem aperiam, eaque ipsa quae.",
    thumbnailSrc:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&h=200&q=80", // Business meeting/consulting
    href: "/service/service-details",
  },
  {
    number: "04",
    ...
    subTitle:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem aperiam, eaque ipsa quae.",
    thumbnailSrc:
      "https://mir-s3-cdn-cf.behance.net/projects/404/64317e222383449.Y3JvcCwxNTM0LDEyMDAsMzQsMA.jpg", // Color palette and design elements
    href: "/service/service-details",
  },
  {
    number: "05",
    ...
    subTitle:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem aperiam, eaque ipsa quae.",
    thumbnailSrc:
      "https://digitalhub.com.pk/wp-content/uploads/2024/06/Graphic-Designing1-1024x614-1-666x450.jpg", // Graphic design workspace with tools
    href: "/service/service-details",
  },
];
